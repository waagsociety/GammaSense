  ...
  get '/lastsensordata' do
    ...
    if res.cmd_tuples() > 0
      ...
      res.each {|tuple|
        ...
        no2_calc = (tuple["no2_offset"].to_f + tuple["no2_no2a_coeff"].to_f * tuple["no2a"].to_f + tuple["no2_no2b_coeff"].to_f * tuple["no2b"].to_f + tuple["no2_t_coeff"].to_f * tuple["temp"].to_f + tuple["no2_rh_coeff"].to_f * tuple["humidity"].to_f).round(2)
        # puts "#{tuple["no2_offset"]} #{tuple["no2_no2a_coeff"]} #{tuple["no2a"]} #{tuple["no2_no2b_coeff"]} #{tuple["no2b"]} #{tuple["no2_t_coeff"]} #{tuple["temp"]} #{tuple["no2_rh_coeff"]} #{tuple["humidity"]}"
